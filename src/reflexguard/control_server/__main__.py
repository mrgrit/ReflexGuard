"""HTTPS dashboard with configurable IP binding and a separately validated public origin."""
import logging
import os
import ssl
import uvicorn
...
def main():
    ...
    host=str(TypeAdapter(IPvAnyAddress).validate_python(os.environ.get("REFLEXGUARD_CONTROL_HOST","127.0.0.1")))
